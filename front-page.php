    ...
    <div class="container mx-auto px-4 relative z-20">
        <div class="max-w-4xl mx-auto text-center fade-in">
            ...
            <p class="text-lg mb-8 opacity-90">
                商社としての調達力に、製造・検査部門の専門性を掛け合わせた
                <br />
                オーダーメイドの生産設備部品で「最適解」を導きます。
            </p>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <p class="text-lg leading-relaxed mb-6">
                        私たちは、単なる機械部品の商社ではありません。
                    </p>

                    <p class="text-lg leading-relaxed mb-6">納品する部品は、99％がオーダーメイド。</p>
                    ...
                    <p class="text-base text-gray-600 leading-relaxed">
                        国内だけでなく、海外にもコネクションを広げ、調達ネットワークはさらに拡大中。すべては、お客様のビジネスを前進させ、最大の満足度をお届けするために。どんな困難なご要望にも応え続けるために。これからも挑戦と進化を続けます。
                    </p>
                </div>
